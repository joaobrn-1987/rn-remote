#!/bin/bash
# RNRemote - Remoção do Agente (CentOS Stream 9 / RHEL 9)
# Uso: sudo bash uninstall-centos.sh
...
echo -e "\n${CYAN}${BOLD}╔══════════════════════════════════════════╗"
echo -e "║   RNRemote — Remoção (CentOS/RHEL 9)     ║"
echo -e "╚══════════════════════════════════════════╝${RESET}\n"

[ "$EUID" -ne 0 ] && err "Execute como root: sudo bash uninstall-centos.sh"
